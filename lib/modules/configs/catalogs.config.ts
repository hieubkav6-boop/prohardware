...
export const catalogsModule = defineModuleWithRuntime({
  ...
  runtimeConfig: {
    fields: [
      ...
      { enabled: true, fieldKey: 'thumbnail', isSystem: false, name: 'Ảnh bìa', order: 3, required: false, type: 'image' },
      ...
      { enabled: true, fieldKey: 'metaTitle', group: 'seo', isSystem: false, name: 'Meta Title', order: 7, required: false, type: 'text' },
      { enabled: true, fieldKey: 'metaDescription', group: 'seo', isSystem: false, name: 'Meta Description', order: 8, required: false, type: 'textarea' },
    ],
  },
});
